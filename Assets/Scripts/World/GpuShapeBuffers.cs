...
public class GpuShapeBuffers : System.IDisposable
{
    ...
    struct CraterGPU
    {
        ...
        public float bigCraters;   // flag owned-cell (0/1)
    }
    ...
    const int ProcStride = 2 * 4, CraterStride = 22 * 4, SeaStride = 5 * 4, TectStride = 10 * 4, PlateStride = 8 * 4;
