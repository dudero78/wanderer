...
> HYG ~119k + **campo profondo 2.37M (ATHYG/Gaia) con frustum-culling a celle** + OpenNGC con FOTO vere (luminosità di
> SUPERFICIE) + **Via Lattea 16k DIFFUSA** (4k/8k/16k da à→Grafica). Skybox-all'infinito (fix tremolio). Effetto stelle
...
> `Mathf.SmoothStep≠GLSL`, l'allineamento Via Lattea, il "feel" del telescopio).
>
